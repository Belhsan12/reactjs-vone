...
const RelatedVideosSidebar = ({ videos, loading, error }) => {
  return (
    <div className="w-full lg:w-80 flex-shrink-0 lg:ml-8 mt-8 lg:mt-0 p-4 rounded-xl bg-white dark:bg-slate-800 shadow-lg dark:shadow-slate-900/40 border border-slate-200 dark:border-slate-700">
        ...
        {loading ? (
          ...
          Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="flex gap-3">
              <div className="relative flex-shrink-0 w-40 h-24 rounded-lg bg-slate-300 dark:bg-slate-700 animate-pulse"></div>
